    ...
    <section id="projects" class="projects-section bg-light">
        <div class="container">
            <div style="margin-top: -4rem;" id="profil">
                <div class="row">
                    <div class="col-12">
                        <a href="#profil" class="js-scroll-trigger">
                            <h4>Tambah Reservasi</h4>
                        </a>
                    </div>
                </div>
                <br>
                <form action="./crud/createreservasi.php" method="post">
                    <div class="row">
                        <div class="col-4"><label Email>Nama</label></div>
                        <div class="col-8"><input class="tabel" name="txtNama" id="txtNama" type="text"
                                style="padding-left: 10px;" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-4"><label Email>Tanggal</label></div>
                        <div class="col-8"><input class="tabel" name="txtTanggal" id="txtTanggal" type="date" required
                                style="padding-left: 10px;" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-4"><label Email>Waktu Check-In</label></div>
                        <div class="col-8"><input class="tabel" name="txtCin" id="txtCin" type="time"
                                style="padding-left: 10px;" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-4"><label Email>Jumlah Orang</label></div>
                        <div class="col-8"><input class="tabel" name="txtOrang" id="txtOrang" type="text"
                                style="padding-left: 10px;" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-4"><label Email>Catatan</label></div>
                        <div class="col-8"><textarea class="tabel" name="txtCatatan" id="txtCatatan" rows="3"
